...
public class Review {
    ...
    public float getWorkEnvironment() {return workEnvironment;}

    public void setWorkEnvironment(float workEnvironment) {this.workEnvironment = workEnvironment;}

    public float getMentorship() {return mentorship;}

    public void setMentorship(float mentorship) {this.mentorship = mentorship;}
    ...
    public AllowanceProvision getAllowanceProvision() {return allowanceProvision;}
